#!/usr/bin/env python3
"""
WashWise — Deployment Script

Sets up the WashWise cloud dashboard (FastAPI + Mosquitto MQTT + optional Postgres).
...
def deploy_local():
    """Deploy WashWise dashboard locally using Docker Compose."""
    dashboard_dir = os.path.join(os.path.dirname(__file__), "..", "software", "dashboard")

    print("🚀 Deploying WashWise locally with Docker Compose...")
    print("=" * 50)
    ...
    print("  🔥 Fire safety: Dryer node monitors 24/7")
    print("=" * 50)


def deploy_cloud():
    """Deploy WashWise to cloud (AWS ECS or GCP Cloud Run)."""
    ...
    print("   8. Configure push notifications (APNs/FCM) for fire alerts")
    print("   9. Configure SMS gateway (Twilio) for EMERGENCY fire alerts")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="WashWise Deployment")
