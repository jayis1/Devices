...
- Piezo buzzer driven by PWM via MOSFET (for 85 dB fire alarm volume)
- Battery charge: MCP73831 with 500mA charge current for 2000mAh LiPo
- USB-C: 5V 2A minimum for charging + operation
- Power supply sequencing: 3.3V before 1.8V (W25Q256)

## Key Design Considerations

- RP2040 Core 0 runs mesh TDMA + fire risk ML + TFT (hard real-time)
...
- Battery backup ensures fire monitoring continues during power outage (critical)
- Piezo alarm driven at high volume for audible fire warning
