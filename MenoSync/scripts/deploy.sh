#!/usr/bin/env bash
# MenoSync — Deployment Script
# Deploys the MenoSync cloud backend, ML pipeline, and configures MQTT.
...
echo ""
echo "=== MenoSync Deployed Successfully ==="
echo "  API:     http://localhost:8000"
echo "  Docs:    http://localhost:8000/docs"
echo "  MQTT:    localhost:1883"
echo "  Topics:  menosync/telemetry/#"
echo "           menosync/alerts/#"
echo "           menosync/voice/#"
echo ""
