# FreshKeep stove-guard Schematic

## KiCad Project

Open `stove-guard.kicad_pro` in KiCad 8+ to view/edit the schematic.
...
- `stove-guard.kicad_sch` — Main schematic
- `stove-guard.kicad_pcb` — PCB layout (work in progress)
- `stove-guard.kicad_pro` — KiCad project file

See BOM in `hardware/bom/stove-guard-bom.csv` for component details.
