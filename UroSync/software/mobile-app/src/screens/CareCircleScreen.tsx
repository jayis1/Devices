...
export default function CareCircleScreen() {
  ...
  return (
    <View style={{ backgroundColor: '#0f172a', borderRadius: 18, padding: 16, gap: 8 }}>
      <Text style={{ color: '#f8fafc', fontSize: 20, fontWeight: '600' }}>Care Circle</Text>
      <Text style={{ color: '#cbd5e1' }}>Shared updates for partner, caregiver, or clinician with privacy controls.</Text>
