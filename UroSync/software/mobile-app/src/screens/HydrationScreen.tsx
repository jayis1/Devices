...
export default function HydrationScreen() {
  ...
  return (
    <View style={{ backgroundColor: '#0f172a', borderRadius: 18, padding: 16, gap: 8 }}>
      <Text style={{ color: '#f8fafc', fontSize: 20, fontWeight: '600' }}>Hydration</Text>
      <Text style={{ color: '#cbd5e1' }}>Bottle intake, urine concentration trend, and next-best drink timing.</Text>
