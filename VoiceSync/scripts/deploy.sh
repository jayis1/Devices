#!/usr/bin/env bash
# VoiceSync — Cloud Deployment Script
#
...
echo "============================================="
echo "  VoiceSync — Cloud Deployment ($ENVIRONMENT)"
echo "============================================="
...
services:
  api:
    ...
    ports: ["8080:8080"]
    environment:
      - JWT_SECRET=${JWT_SECRET:-voicesync-dev-secret}
      - POSTGRES_URL=postgres://voice:***@db:5432/voicesync
  ...
  influxdb:
    ...
    environment:
      ...
      DOCKER_INFLUXDB_INIT_USERNAME: voice
      DOCKER_INFLUXDB_INIT_PASSWORD: voicesync123
      DOCKER_INFLUXDB_INIT_ORG: voicesync
